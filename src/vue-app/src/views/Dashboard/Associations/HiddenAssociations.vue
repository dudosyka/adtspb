<template>
    <div class="dashboard-associations-hidden">
...
import AdminAssociationTable from "@/components/AdminAssociationTable";
export default {
    name: "DashboardAssociationsHidden",
    ...
    components: {AdminAssociationTable},
}
</script>
