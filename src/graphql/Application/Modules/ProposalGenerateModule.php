...
//// Убирай мета теги - они вызывают ошибку iconv(): Wrong charset, conversion from `UNICODE' to `UTF-8//TRANSLIT' is not allowed
        $mpdf->WriteHTML("
            ...
            <div style='width: 300px; float: right; display: block;'>
                ...
                Ковалеву Дмитрию Сергеевичу</p>
                <p style='text-align: left; padding-bottom: 0; margin-bottom: 0;'>От <u>{$parent_surname} {$parent_name} {$parent_midname}</u></p>
            ...
            <div style='padding-top: 100px; width: 100%;'>
                ...
                <p>Объединение: <u>{$group_title}</u></p>
                ...
                <ol>
                    ...
                    <li><b>Образовательное учреждение по основному месту обучения:</b> 					<u>{$child_study_place}</u></li>
                    <li><b>Класс/группа по основному месту обучения:</b> 								<u>{$child_study_class}</u></li>
